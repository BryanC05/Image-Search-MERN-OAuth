  ...
  return (
    <div className="login-container">
      <div className="login-card">
        ...
        <p className="description">Sign in to start searching for beautiful images and build your collections</p>
        <div className="oauth-buttons">
          ...
          <button className="oauth-btn github" onClick={() => handleOAuthLogin("github")}>
            <svg className="oauth-icon" viewBox="0 0 24 24" fill="currentColor">
